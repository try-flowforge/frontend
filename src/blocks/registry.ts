...
export function generateIconRegistry(): IconRegistry {
  ...
  const logoMap: Record<string, ComponentType<{ className?: string }>> = {
    ...
    YearnLogo: logos.YearnLogo,
    BeefyLogo: logos.BeefyLogo,
    StargateLogo: logos.StargateLogo,
    AcrossLogo: logos.AcrossLogo,
    GMXLogo: logos.GMXLogo,
    HyperliquidLogo: logos.HyperliquidLogo,
    OstiumLogo: logos.OstiumLogo,
    CamelotLogo: logos.CamelotLogo,
    GammaLogo: logos.GammaLogo,
    LidoLogo: logos.LidoLogo,
    PendleLogo: logos.PendleLogo,
    FraxLogo: logos.FraxLogo,
    RadiantLogo: logos.RadiantLogo,
    TreasureLogo: logos.TreasureLogo,
    OpenSeaLogo: logos.OpenSeaLogo,
    SnapshotLogo: logos.SnapshotLogo,
    TallyLogo: logos.TallyLogo,
    DefiLlamaLogo: logos.DefiLlamaLogo,
    ZapperLogo: logos.ZapperLogo,
    NexusMutualLogo: logos.NexusMutualLogo,
    InsurAceLogo: logos.InsurAceLogo,
